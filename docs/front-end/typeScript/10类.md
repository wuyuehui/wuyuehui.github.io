...
class Cat extends Animal { // ERROR 非抽象类“Cat”没有实现继承自“Animal”类的抽象成员“sayHi”。
    public eat() {
...
var Cat = (function (_super) {
    ...
    Cat.prototype.sayHi = function () {
        console.log("Meow, My name is ".concat(this.name));
    };
    return Cat;
}(Animal));
...
[TypeScript入门教程](https://ts.xcatliu.com/advanced/class.html)
